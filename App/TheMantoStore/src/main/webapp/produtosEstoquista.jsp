                     ...
                     <tr>
                        ...
                        <td>
                           <div class="d-flex gap-2">
                                 ...
                                 <div class="modal-dialog">
                                    <div class="modal-content p-4">
                                       ...
                                       <div class="modal-body">
                                          ...
                                          <form action="/AtualizarQuantidadeProduto" method="post" enctype="multipart/form-data">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                       ...
                                                       value="${produto.nomeProduto}" disabled>
                                             </div>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input type="file" class="form-control"
                                                       name="imagemProduto"
                                                       id="imageProduto-${produto.id}" disabled>
                              ...
                              <button class="btn btn-success" disabled>Visualizar</button>
                              <!-- Switch de status -->
                                 ...
                                 <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox"
                                       ...
                                       ${produto.status ? 'checked' : ''}
                                           ...
                                           data-bs-target="#confirmModal-${produto.id}" disabled>
                           ...
                           <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                 ...
                                 <form action="/AlterarStatusProduto" method="post">
                                    <input type="hidden" name="id" value="${produto.id}" disabled>
                                    <input type="hidden" name="status" value="${!produto.status}" disabled>
                                    <input type="hidden" name="page" value="${currentPage}" disabled>
                  ...
                  <div class="modal-body">
                     <form action="/CadastrarProduto" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="id" id="id"
                               value="${param.id != null && param.id != '' ? param.id : 0}" disabled>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                           ...
                           <input type="number" step="0.5" min="0.5" max="5" class="form-control"
                                  id="avaliacao" name="avaliacao" disabled>
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-primary mt-3" disabled>Cadastrar</button>
