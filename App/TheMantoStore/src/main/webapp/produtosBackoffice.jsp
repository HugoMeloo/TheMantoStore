                                    ...
                                    <div class="d-flex gap-2">
                                       ...
                                       <form id="statusForm-${produto.id}" action="/AlterarStatusProduto" method="post" class="d-flex align-items-center">
                                          ...
                                          <div class="form-check form-switch">
                                             <input class="form-check-input" type="checkbox" id="statusSwitch-${produto.id}"
                                             ${produto.status ? 'checked' : ''}
                                             data-bs-toggle="modal" data-bs-target="#confirmModal-${produto.id}">
                        ...
                        <div class="modal-body">
                           <form action="/CadastrarProduto" method="post" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" id="produto-name" name="produto-name" maxlength="255" required>
                              </div>
                              <div class="form-group">
                                 <label for="avaliacao">Avaliação:</label>
                                 <input type="number" step="0.5" min="0.5" max="5" class="form-control" id="avaliacao" name="avaliacao" required>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="file" class="form-control" name="imageProduto" id="imageProduto" multiple required>
                                 <small>Selecione múltiplas imagens</small>
                              </div>
                              <button type="submit" class="btn btn-primary mt-3">Cadastrar</button>
                              <button type="button" class="btn btn-secondary mt-3" onclick="window.location.href='/ExibirProdutos'">Cancelar</button>
                           </form>
                        </div>
                     </div>
                  </div>
