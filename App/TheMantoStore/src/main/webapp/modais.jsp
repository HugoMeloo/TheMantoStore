...
<div class="modal fade" id="confirmModal" tabindex="-1"
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>
          O produto <strong id="modalNomeProduto"></strong> (ID: <strong id="modalProdutoIdTexto"></strong>) está atualmente
...
<div class="modal fade" id="updateProdutoModal" tabindex="-1" aria-labelledby="updateProdutoModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content p-4">
      ...
      <div class="modal-body">
        <form action="/CadastrarProduto" method="post" enctype="multipart/form-data">
          <input type="hidden" name="id" id="updateProdutoId">

          <div class="form-group">
            <label>Nome do Produto:</label>
            <input type="text" class="form-control" id="updateProdutoNome" name="produto-name" required>
          </div>

          <div class="form-group">
            <label>Avaliação:</label>
            <input type="number" step="0.5" min="0.5" max="5" class="form-control"
                   id="updateProdutoAvaliacao" name="avaliacao" required>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="updateProdutoPreco" name="preco" required>
          </div>

          <div class="form-group">
            <label>Selecionar novas imagens (opcional):</label>
            <input type="file" class="form-control" name="imagemProduto" multiple>
